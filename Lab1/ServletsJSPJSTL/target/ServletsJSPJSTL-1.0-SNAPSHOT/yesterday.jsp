...
<html>
    ...
    <body>
        ...
        <p>
            (default) Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="default"/><br/>
            (short) Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="short"/><br/>
            (medium) Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="medium"/><br/>
            (long) Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="long"/><br/>
            (full) Released: <fmt:formatDate value="${releaseDate}" type="date" dateStyle="full"/>
        </p>
        <c:if test="${!empty members}">
            <table border="${bean.borders}">
